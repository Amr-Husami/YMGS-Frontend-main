    ...
    <div className="dark:bg-gray-800">
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-gray-600 dark:text-gray-300 text-right'>
          <p>مرحباً بكم في صيدلية الشام، صيدليتكم الإلكترونية الموثوقة! نُقدّم لكم طريقة سلسة لطلب الأدوية والمستلزمات الطبية عبر الإنترنت، مع ضمان وصول احتياجاتكم الصحية الأساسية بسرعة وسهولة. في صيدلية الشام، صحتكم هي أولويتنا القصوى.</p>
          ...
          <p>في صيدلية الشام، نلتزم بجعل الرعاية الصحية في متناول الجميع. رسالتنا هي توفير خدمة توصيل أدوية موثوقة وفعّالة، لضمان حصول كل شخص على دوائه المناسب في الوقت المناسب. نحن نجسر الفجوة بين مقدمي الرعاية الصحية والمرضى من خلال حلول تقنية متطورة.</p>
        </div>
      </div>
