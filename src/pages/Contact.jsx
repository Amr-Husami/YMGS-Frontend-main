    ...
    <div className="dark:bg-gray-800">
      ...
      {loading ? (
        ...
        <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
          ...
          />
          <div className='flex flex-col justify-center items-start gap-8 text-right'>
            <div>
              <p className='font-semibold text-xl text-gray-800 dark:text-gray-200 mb-4'>تواصل معنا</p>
              <p className='text-gray-600 dark:text-gray-300 max-w-md'>هل لديك استفسار عن المنتجات أو التوصيل؟ نحن هنا لمساعدتكم في الحصول على أجود الأدوية والفيتامينات بأفضل الأسعار.</p>
            </div>

            <div className='flex flex-col gap-6'>
              <div className='flex items-center gap-3 text-gray-600 dark:text-gray-300 flex-row-reverse'>
              ...
              <div className='flex items-center gap-3 text-gray-600 dark:text-gray-300 flex-row-reverse'>
                ...
                <p dir="ltr">{contactInfo.contactPhone}</p>
              </div>

              <div className='flex items-center gap-3 text-gray-600 dark:text-gray-300 flex-row-reverse'>
                <Mail className='text-primary dark:text-[#02ADEE]' size={20} />
                <p dir="ltr">{contactInfo.contactEmail}</p>
              </div>
      ...
      <div className="container px-4 mx-auto">
        <div className="mx-auto">
          <div className="max-w-md mx-auto px-8 py-6 bg-gray-100 dark:bg-gray-700 rounded-lg shadow-lg">
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4 text-right">أرسل رسالة</h2>
            <form onSubmit={handleSubmit} className="text-right">
              <div className="mb-4">
                <label className="block text-gray-800 dark:text-gray-200 mb-1" htmlFor="name">اسمك الكامل</label>
                <input
                  className="w-full px-4 py-2 bg-gray-200 dark:bg-gray-600 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-300 dark:focus:ring-yellow-400 transition duration-300 text-right"
              ...
              <div className="mb-4">
                <label className="block text-gray-800 dark:text-gray-200 mb-1" htmlFor="email">البريد الإلكتروني</label>
                <input
                  className="w-full px-4 py-2 bg-gray-200 dark:bg-gray-600 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-300 dark:focus:ring-yellow-400 transition duration-300 text-right"
              ...
              <div className="mb-4">
                <label className="block text-gray-800 dark:text-gray-200 mb-1" htmlFor="phone">رقم الهاتف</label>
                <input
                  className="w-full px-4 py-2 bg-gray-200 dark:bg-gray-600 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-300 dark:focus:ring-yellow-400 transition duration-300 text-right"
              ...
              <div className="mb-4">
                <label className="block text-gray-800 dark:text-gray-200 mb-1" htmlFor="message">رسالتك</label>
                <textarea
                  className="w-full px-4 py-2 bg-gray-200 dark:bg-gray-600 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-300 dark:focus:ring-yellow-400 transition duration-300 text-right"
