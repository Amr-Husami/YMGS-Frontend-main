  ...
  return (
    <div className="bg-[#7ccfff] dark:bg-gray-900 mt-10 py-8 px-6 shadow-inner">
      <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 mb-10 text-small">
        ...
        <div>
          <p className="text-xl font-medium mb-5 text-gray-800 dark:text-gray-100">الشركة</p>
          <ul className="flex flex-col gap-2 text-gray-600 dark:text-gray-300">
            <li>
              <NavLink to="/products" className="hover:text-primary dark:hover:text-[#02ADEE] transition-colors">المنتجات</NavLink>
            </li>
            <li>
              <NavLink to="/about" className="hover:text-primary dark:hover:text-[#02ADEE] transition-colors">من نحن</NavLink>
            </li>
            <li>
              <NavLink to="/contact" className="hover:text-primary dark:hover:text-[#02ADEE] transition-colors">تواصل معنا</NavLink>
            </li>
            <li>
              <NavLink to="/policy" className="hover:text-primary dark:hover:text-[#02ADEE] transition-colors">الشروط والأحكام</NavLink>
            </li>
          </ul>
        </div>

        <div>
          <p className="text-xl font-medium mb-5 text-gray-800 dark:text-gray-100">تواصل معنا</p>
          <ul className="flex flex-col gap-2 text-gray-600 dark:text-gray-300">
            {loading ? (
              <li className="text-sm opacity-70">جارٍ التحميل...</li>
            ) : (
              <>
