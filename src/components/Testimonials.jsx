  ...
  const testimonials = [
    {
      ...
      stars: 5,
      text: "صيدلية الشام أنقذتني في أوقات كثيرة! التوصيل السريع وجودة الأدوية الأصيلة جعلت إدارة صحتي أسهل بكثير. عملية الطلب سلسة جداً وسهلة."
    },
    {
      id: 2,
      name: "محمد الخطيب",
      ...
      stars: 5,
      text: "أقدّر كثيراً الاتساق والموثوقية في صيدلية الشام. خدمة الاشتراك الشهري تضمن عدم نفاد أدويتي الدائمة، وخدمة العملاء ممتازة."
    },
    {
      id: 3,
      name: "ريم المصري",
      ...
      stars: 4,
      text: "بصفتي عاملة في القطاع الصحي، أنا دقيقة جداً في جودة الأدوية. صيدلية الشام تُسلّم منتجات أصيلة دائماً وخدمتها سريعة واحترافية. أنصح بها بشدة!"
    },
    {
      id: 4,
      name: "خالد العمر",
      ...
      stars: 5,
      text: "كنت متشككاً في البداية من طلب الأدوية عبر الإنترنت، لكن صيدلية الشام فاقت توقعاتي. الأدوية وصلت في الوقت المحدد وكانت بالضبط ما احتجته. سأكرر الطلب!"
    },
    {
      id: 5,
      name: "أميرة حسن",
      ...
      stars: 5,
      text: "خدمة التوصيل المنزلي من صيدلية الشام نعمة كبيرة لأمثالي من كبار السن. الموصلون مؤدبون جداً والأدوية معبأة بشكل سليم. راضية جداً!"
    }
  ];
      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-gray-600 dark:text-gray-300">
            اقرأ آراء عملائنا الراضين الذين يثقون بصيدلية الشام لتلبية احتياجاتهم الصحية.
          </p>
        </div>
